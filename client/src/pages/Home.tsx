      ...
      >
        <div className="container flex items-center justify-between h-16 md:h-20">
          <div className="flex items-center gap-2.5">
            <img src={APP_LOGO} alt="Jisr logo" className="w-15 h-15 shadow-lg shadow-[#00D8FF]/20 rounded-2xl" />
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="reveal">
                ...
                <div className="flex flex-wrap gap-4">
                  <a
                    href="https://apps.apple.com/se/app/%D8%AC-%D8%B3%D8%B1-jisr/id6764436814?l=en-GB"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 px-6 py-3.5 rounded-2xl bg-white/50 text-[#0A0F1A]/60 font-semibold shadow-lg hover:bg-white/60 hover:text-[#0A0F1A] transition-all duration-200 cursor-pointer"
                  >
